...
expected_url="https://github.com/${REPO}/releases/download/v${release_version}/webstream-module.tar.gz"
expected_url_core="https://github.com/${REPO}/releases/download/v${release_version}/webstream-module-core.tar.gz"
